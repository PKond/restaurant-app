    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link to={"/"} classname="flex items-center gap2">
          ...
          <p className="text-headingColor tet-xl font-bold"> City</p>
        </Link>
        ...
        <div className="flex item-center gap-8">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "pandelis777@gmail.com" && (
                  <Link to="/createItem">
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col px-4 py-2 gap-8">
                <li
                  classname="text-base text-textColor hover:text-headingColor duration-100 transition-all cursor-pointer hover:bg-slate-200 px-4 py-2"
                  onClick={() => setIsMenu(false)}
                >
                  Home
                </li>
